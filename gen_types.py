...
include_re = re.compile(r'^\s*#\s*include\s+"(?P<name>[^"]+)"\s*$')

check_re = re.compile(
    r'(?:[^_A-Za-z0-9]|^)Py(?P<name>[A-Za-z0-9]+?)_Check(?:[^_A-Za-z0-9]|$)')
check_exact_re = re.compile(
    r'(?:[^_A-Za-z0-9]|^)Py(?P<name>[A-Za-z0-9]+?)_CheckExact(?:[^_A-Za-z0-9]|$)')
type_re = re.compile(
    r'(?:[^_A-Za-z0-9]|^)Py(?P<name>[A-Za-z0-9]+?)_Type(?:[^_A-Za-z0-9]|$)')
object_re = re.compile(
    r'(?:[^_A-Za-z0-9]|^)Py(?P<name>[A-Za-z0-9]+?)Object(?:[^_A-Za-z0-9]|$)')
...
def write_h_header(f, name):
    ...
    print(f"#include <{name}/Python.h>", file=f)
    print(f"#include <{name}/frameobject.h>", file=f)
    print("", file=f)
...
def write_cmd_go_header(f, name):
    pkgname = name.replace('python', 'python-')
    print('// Code generated by gen_types.py. DO NOT EDIT.', file=f)
    print('', file=f)
    print('package main', file=f)
    print('', file=f)
    print('// #cgo CFLAGS: -Werror', file=f)
    print(f'// #cgo pkg-config: {pkgname}-embed libffi', file=f)
    print('//', file=f)
    print(f'// #include <{name}/Python.h>', file=f)
    print('import "C"', file=f)
    print('', file=f)
