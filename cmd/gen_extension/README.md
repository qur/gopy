...
```go
//go:generate go run gopython.xyz/py/v14/cmd/gen_extension name file.go
```
...
```go
//go:generate go run gopython.xyz/py/v14/cmd/gen_extension -package main -func initExtension name file.go
```
