...
#define CLASS_HAS_MP_LENGTH 0x0004000000000000ull
#define CLASS_HAS_MP_SUBSCRIPT 0x0008000000000000ull
#define CLASS_HAS_MP_ASS_SUBSCRIPT 0x0010000000000000ull
